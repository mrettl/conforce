...
def compute_F_for_C3D10R(
        ...
        U_at_nodes):
    """
    Computes the deformation gradients for num_elem elements of typ C3D10R.
    Each element has n=10 nodes and ips=1 integration points.
...
def compute_P_for_C3D10R(
        ...
        S_at_int_points):
    """
    Computes the first Piola-Kirchhoff stress tensors for num_elem elements of typ C3D10R.
    Each element has n=10 nodes and ips=1 integration points.
...
def compute_CS_for_C3D10R_using_dbf(
        ...
        S_at_int_points):
    """
    Computes the configurational stresses for num_elem elements of typ C3D10R.
    Each element has n=10 nodes and ips=1 integration points.
    ...
    lib.compute_CS_for_C3D10R_using_dbf(
        ctypes.c_size_t(num_elem),
        e_at_int_points.ctypes.data_as(ctypes.c_void_p),
        X_at_nodes.ctypes.data_as(ctypes.c_void_p),
        U_at_nodes.ctypes.data_as(ctypes.c_void_p),
...
def compute_CF_for_C3D10R_using_dbf(
        ...
        S_at_int_points):
    """
    Computes the configurational forces for num_elem elements of typ C3D10R.
    Each element has n=10 nodes and ips=1 integration points.
    ...
    lib.compute_CF_for_C3D10R_using_dbf(
        ctypes.c_size_t(num_elem),
        e_at_int_points.ctypes.data_as(ctypes.c_void_p),
        X_at_nodes.ctypes.data_as(ctypes.c_void_p),
        U_at_nodes.ctypes.data_as(ctypes.c_void_p),
...
def compute_CS_for_C3D10R_using_mbf(
    ...
    lib.compute_CS_for_C3D10R_using_mbf(
        ctypes.c_size_t(num_elem),
        e_at_int_points.ctypes.data_as(ctypes.c_void_p),
        X_at_nodes.ctypes.data_as(ctypes.c_void_p),
        U_at_nodes.ctypes.data_as(ctypes.c_void_p),
...
def compute_CF_for_C3D10R_using_mbf(
    ...
    lib.compute_CF_for_C3D10R_using_mbf(
        ctypes.c_size_t(num_elem),
        e_at_int_points.ctypes.data_as(ctypes.c_void_p),
        X_at_nodes.ctypes.data_as(ctypes.c_void_p),
        U_at_nodes.ctypes.data_as(ctypes.c_void_p),
