...
def build_2d(is_full_output_precision, material_orientation_in_degree):
    # reset model
    abq.Mdb()
    ...
    job = abq.mdb.Job(
        ...
        nodalOutputPrecision=abqConst.FULL if is_full_output_precision else abqConst.SINGLE
    )
    job.submit()
