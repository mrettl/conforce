...
def calc_Conf_Force_C3D6_static(Coords,Element_U,S_vec,PENER,SENER,method='mbf'):
    """
    Inputs:
        Coords.........Element_Nodal_Coordinates [num_elem,numNodes,3]
        Element_U......Element_Nodal_Displacements [num_elem,numNodes,3]
    ...
    if method=='mbf':
        lib.Integration_C3D6_static_mbf(num_elem_,Coords_p,Element_U_p,S_vec_p,PENER_p,SENER_p,Conf_Force_p)
    elif method=='dbf':
        lib.Integration_C3D6_static_dbf(num_elem_,Coords_p,Element_U_p,S_vec_p,PENER_p,SENER_p,Conf_Force_p)
    else:
        print("Method not found!")
    return Conf_Force

def calc_Conf_Force_C3D6_dynamic(Coords,rho,Element_U,Element_V,Element_A,S_vec,PENER,SENER):
    """
    Inputs:
        Coords.........Element_Nodal_Coordinates    [num_elem,numNodesPerElem,3]
        rho............Density                      [num_elem]
    ...
    lib.Integration_C3D6_dynamic(num_elem_,Coords_p,rho_p,Element_U_p,Element_V_p,Element_A_p,S_vec_p,PENER_p,SENER_p,Conf_Force_p)
    return Conf_Force
