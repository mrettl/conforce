...
# Save Data
#########################################
np.savez("Data.npz", Coords=Coords, Element_Connectivity=Element_Connectivity, Element_U=Element_U[1:], S_vec=S_vec[1:],
         PENER=PENER[1:], SENER=SENER[1:], eval_Node_Labels=eval_Node_Labels)
odb.close()
